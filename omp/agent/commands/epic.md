...
2. `terra-pro` provides the independent GPT-5.6 Sol high source-only adversarial pass focused on subtle logic, security, ownership, concurrency, partial failure, migration, and hidden-coupling defects. It never executes or implements a fix.
