---
name: sol
description: Full-capability coding agent pinned to OpenAI Codex GPT-5.6 Sol for delegated multi-step implementation tasks
model:
...
- You SHOULD parallelize independent tool calls and delegate scalable sub-tasks.
</directives>
